...
match = re.match(
    pattern=r'.*TCODFOV_STRVERSION *"(?P<release>(?P<version>\d+\.\d+)[^"]*)',
    string=open("../src/libtcod/version.h", encoding="utf-8").read(),
    flags=re.DOTALL,
)
assert match
...
exclude_patterns = ["_build", "README.md", "*.inc.rst"]
...
latex_documents = [
    (master_doc, "libtcod.tex", "libtcod Documentation", "Richard Tew", "manual"),
]
...
man_pages = [(master_doc, "libtcod", "libtcod Documentation", [author], 1)]
